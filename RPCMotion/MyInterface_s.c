...
extern const MIDL_SERVER_INFO MyRpcInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE MyRpcInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE MyRpcInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x12345778,0x1234,0xABCD,{0xEF,0x00,0x01,0x23,0x45,0x67,0x89,0xAC}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&MyRpcInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &MyRpcInterface_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE MyRpcInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& MyRpcInterface___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION MyRpcInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE MyRpcInterface_v1_0_DispatchTable = 
    {
    7,
    (RPC_DISPATCH_FUNCTION*)MyRpcInterface_table
    };
...
static const MIDL_STUB_DESC MyRpcInterface_StubDesc = 
    {
    (void *)& MyRpcInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& MyRpcInterface_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION MyRpcInterface_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE MyRpcInterface_NDR64__v1_0_DispatchTable = 
    {
    7,
    (RPC_DISPATCH_FUNCTION*)MyRpcInterface_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO MyRpcInterface_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&MyRpcInterface_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE MyRpcInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Ping,
    (SERVER_ROUTINE)Execute,
    (SERVER_ROUTINE)ExecuteSilent,
    (SERVER_ROUTINE)UploadFile,
    (SERVER_ROUTINE)DownloadFile,
    (SERVER_ROUTINE)ListDirectory,
    (SERVER_ROUTINE)ShutDown
    };

static const MIDL_SERVER_INFO MyRpcInterface_ServerInfo = 
    {
    &MyRpcInterface_StubDesc,
    MyRpcInterface_ServerRoutineTable,
    MyInterface__MIDL_ProcFormatString.Format,
    (unsigned short *) MyRpcInterface_FormatStringOffsetTable,
    0,
